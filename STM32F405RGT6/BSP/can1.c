...
/*************************************************************************
                          CAN1_Configuration
Configuration：Reset CAN1 Configuration to 1M Baud
*************************************************************************/
...
//If break, it will enter this function once per 1ms. 如果中断开启，则1ms进入该函数一次
...
/*************************************************************************
                          CAN1_RX0_IRQHandler
Description：Reception of Head Motor's CAN data is broken
*************************************************************************/
...
/*************************************************************************
                            Motor_Reset
Description：Reset the driver that connected with the main control board 将挂接在主控板上的驱动器复位
...
/*************************************************************************
                            Motor_Init
Description：Initialize the driver that connected to the main control board  将挂接在主控板上的驱动器初始化
Input parameter： int Motor_ID     Optional Parameter： MOTOR_NUM1   MOTOR_NUM2  
                                       MOTOR_NUM3   MOTOR_NUM4
                                       MOTOR_NUM5   MOTOR_NUM6
                                       MOTOR_NUM7   MOTOR_NUM8
Input parameter： int Motor_Mode   Optional Parameter： PWM_MODE 
                                       SPEED_MODE 
                                       PWM_LOCATION_MODE 
                                       SPEED_LOCATION_MODE
*************************************************************************/
...
/*************************************************************************
                           MOTOR_PWM_Set
Description：Setup of driver in PWM Mode 
Input Parameter： int Motor_ID     Optional Parameter： MOTOR_NUM1   MOTOR_NUM2  
                                       MOTOR_NUM3   MOTOR_NUM4
                                       MOTOR_NUM5   MOTOR_NUM6
                                       MOTOR_NUM7   MOTOR_NUM8
Input Parameter： int Give_PWM   Range -5000 -- 0 -- 5000
*************************************************************************/
